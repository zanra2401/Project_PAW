...
<body class="h-screen flex">
    ...
    <main class="w-full min-h-screen box-border bg-gray-50 overflow-hidden flex flex-col p-6">
        ...
        <!-- Informasi Laporan -->
        <div class="mb-6">
            <p class="text-gray-700 mb-1"><span class="font-semibold">Username:</span> <?= $data['laporan']['username_user']?></p>
            <!-- <p class="text-gray-700 mb-1"><span class="font-semibold">Judul Laporan:</span> <?= $data['laporan']['judul_laporan']?></p> -->
            <p class="text-gray-700"><span class="font-semibold">Tanggal:</span> 2024-06-17</p>
        </div>
