...
<body class="bg-gray-50 flex items-center justify-center min-h-screen">
  <div class="bg-white shadow-md rounded-lg p-8 w-full max-w-sm" style="padding-left: 20px;padding-right: 20px">
    <!-- <div class="flex justify-center mb-4">
        <img class="w-16 h-16" src="<?= PROJECT_NAME?>/assets/image/centang.png" alt="Illustration" class="w-2/3">
    </div> -->
    ...
    <form method="post" action="/<?= PROJECT_NAME ?>/account/lupapassword">
      ...
      <div class="flex justify-center">
        <button type="submit" class="w-40 text-white py-2 px-4 rounded-md bg-red-500 hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-[#c48d6e] focus:ring-offset-2">
          Lanjut
        </button>
      </div>
    </form>
