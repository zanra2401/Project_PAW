...
<body class="bg-gray-50 flex items-center justify-center min-h-screen">
  <div class="bg-white shadow-md rounded-lg p-8 w-full max-w-sm" style="padding-left: 20px;padding-right: 20px">
    ...
    <h4 class=" font-bold text-orange-500 text-center" style="font-size: 22px;margin-bottom: 17px">Terimakasih Pendaftaran Akunmu Berhasil!</h4>
    <p class="text-gray-700 text-center mb-6">
    Selamat datang! Kami senang Anda bergabung dengan kami. Mulailah perjalanan Anda dengan mencari kos.
    </p>
