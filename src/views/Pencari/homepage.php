...
<body>
    ...
    <form action="/<?= PROJECT_NAME ?>/Pencari/homepage" method="POST">
        <div class="absolute top-0 left-0 h-3/4 bg-[#d7dbdd] rounded-b-[50px] -z-10 overflow-y-hidden"
            style="width: 100%;"></div>
        <div class="w-[90%] rounded-3xl mt-[50px] mx-auto">
            <h1 class="text-center text-3xl font-bold px-4" style="color:#83493d;">Sekarang Cari Kost Bisa Sambil
                Rebahan</h1>
            ...
            <div class="flex bg-white mx-auto rounded-full mt-[20px] justify-center items-center search-bar"
                style="height: 70px; width: 70%; gap:10px;">
                <div class="relative w-1/2 field-inputan-search">
                    <input name="lokasi_nama" type="text" placeholder="Cari lokasi atau nama kost.."
                        class="w-full p-3 pl-10 border border-gray-300 rounded-full shadow-md focus:outline-none focus:ring focus:ring-warna-second">
                ...
                <div class="relative">
                    ...
                    <button id="dropdownButton" type="button"
                        class="inline-flex justify-between w-full min-w-[160px] p-3 pl-10 pr-8 border border-gray-300 bg-white rounded-full shadow-md focus:outline-none focus:ring focus:ring-blue-300 items-center">
                        ...
                        <i
                            class="fas fa-caret-down absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500"></i>
                    </button>

                    <!-- Menu Dropdown -->
                    <div id="dropdownMenu"
                        class="absolute hidden bg-white shadow-lg ring-1 ring-black ring-opacity-5 mt-2 w-full rounded-2xl z-10">
                        <div class="py-1">
                            <div class="flex items-center px-4 py-2 hover:bg-gray-100 cursor-pointer dropdown-item"
                                data-value="Putra">
                ...
                <div class="relative">
                    <button type="submit" name="find"
                        class="inline-flex justify-center w-full p-3 pl-10 pr-8 borde rounded-full shadow-md tombol-search hover:opacity-70"
                        style="background-color: #83493d; color:#fff;">
                        <span class="temukan-kost">Temukan Kost</span>
                    </button>
                    <i
                        class="fas w-20 fa-search absolute left-3 top-1/2 transform -translate-y-1/2 text-white cursor-pointer logo-search"></i>
                </div>
                <div class="relative logo-menu">
                    <button type="button" class="w-full p-3 rounded-full hover:opacity-70" id="filter_button"><i
                            class="fas fa-sliders top-1/2 transform text-gray-500 "></i></button>
                </div>
            </div>
    </form>
    </div>
    ...
    <div id="filter" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50 hidden">
        <div class="bg-white rounded shadow-lg w-1/2 transition-all duration-300 transform scale-0 h-[80%]"
            id="contain_filter">
                    ...
                    <div class="grid gap-5">
                        ...
                        <div class="grid gap-3">
                            <label class="flex items-center gap-3">
                                ...
                                <div
                                    class="w-5 h-5 rounded-full border-2 border-gray-300 peer-checked:border-warna-second peer-checked:bg-warna-second transition">
                                </div>
                                <span class="text-gray-700 peer-checked:text-warna-second font-medium">Harga
                                    terendah</span>
                            </label>
                            <label class="flex items-center gap-3">
    ...
    dropdownItems.forEach(item => {
        item.addEventListener('click', () => {
            ...
            if (value === 'pria') {
                iconLeft.className =
                    'fas fa-person absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500';
            } else if (value === 'wanita') {
                iconLeft.className =
                    'fas fa-person-dress absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500';
            }
