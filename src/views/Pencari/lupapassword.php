...
<body class="bg-gray-50 flex items-center justify-center min-h-screen">
  <div class="bg-white shadow-md rounded-lg p-8 w-full max-w-sm">
    ...
    <form method="POST">
      ...
      <?php echo $message; ?>
      <button type="submit" class="w-full text-white py-2 px-4 rounded-md bg-[#c48d6e] hover:bg-base-color focus:outline-none focus:ring-2 focus:ring-[#c48d6e] focus:ring-offset-2">
        Lanjut
      </button>
    </form>
  </div>
