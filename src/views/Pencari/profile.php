        ...
        <div class="flex">
            ...
            <div class="w-full">
                ...
                <div class="p-10 border-t border-grey grid gap-5" id="content_profle">
                    ...
                    <form action="/<?= PROJECT_NAME ?>/Pencari/profile" class="grid gap-5" method="POST">
                        <div class="flex items-center gap-7">
                            <img src="<?= $data['data_user'][0]['profile_user']?>" alt="profile" class="border-2 w-40 h-40 overflow-hidden rounded-full" id="profile-picture">
                            <div class="flex gap-3">
                                ...
                                <button type="button" class="px-4 py-2 bg-red-500 text-white font-bold rounded hover:bg-red-600 transition">
                                    Delete Picture
                                </button>
                            </div>
                        </div>
                        ...
                        <input 
                            ...
                            value="<?=$data['data_user'][0]['nama_user']?>"
                        >
                        ...
                        <input 
                            ...
                            class="px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2"
                            value="<?=$data['data_user'][0]['username_user']?>"
                        >
                        ...
                        <input 
                            ...
                            class="px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2"
                            value="<?=$data['data_user'][0]['email_user']?>"
                        >
                        ...
                        <input 
                            ...
                            class="px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2"
                            value="<?=$data['data_user'][0]['no_HP_user']?>"
                        >
