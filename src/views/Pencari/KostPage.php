    ...
    <div class="w-[90%] mx-auto pt-4 h-16 items-center">
        <nav class="flex" aria-label="Breadcrumb">
            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <a href="/project_paw/pencari/homepage" class="inline-flex items-center text-sm font-medium text-gray-700  hover:text-[#83493d] dark:text-gray-400 dark:hover:text-white">
                ...
                <div class="flex items-center">
                    ...
                    <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Judul Kost</span>
                </div>
                </li>
            </ol>
        </nav>
