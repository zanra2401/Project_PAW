...
<footer class="w-[90%] shadow-lg" style="margin-top:50px; background-color: #28282B	; width: 100%;">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="menu-foot">
            ...
            <div>
                ...
                <ul class="font-medium" style="color: #fff;">
                    ...
                    <a href="#" class="hover:underline">+62 815-1590-0633</a>
                    </li>
                    <li>
                    <i class="fa-regular fa-envelope"></i>
                    <a href="#" class="hover:underline">info@cariKost.co</a>
                    </li>
                </ul>
            </div>
        </div>
      ...
      <div class="flex sm:items-center sm:justify-between justify-between items-center credit" style="margin-top:10px;">
          ...
          <div class="sm:justify-center sm:mt-0" style="display: flex; gap:5px;">
              ...
              <a href="#" class="hover:text-gray-900 ms-5" style="color: #fff;">
